...
train1.each_carriage { |carriage| puts "Количество свободного пространства #{carriage.free_capacity}" }
station1.each_train { |train| puts "Поезда на станции #{train.number}" }
